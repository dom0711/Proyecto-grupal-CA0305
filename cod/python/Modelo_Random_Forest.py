...
class ModeloRandomForest:
    ...
    def __init__(self, data, preproceso):
        ...
        Parametros:
         ...
         Returns:
             Un objeto del tipo ModeloRandomForest
        '''
        self.data = data
    ...
    def __str__(self):
        ...
        '''
        return "ModeloRandomForest con RandomForestClassifier"

    
    def crear_pipeline(self):
        '''
        Método que crea el pipeline con el preproceso y el modelo Random Forest
        '''
